    ...
    <article className="w-[90%] mb-2 relative text-white bg-white">
      ...
      <div className="text-base flex flex-col mb-2 shadow-2xl text-black">
        ...
        <div className="flex items-center">
          ...
          {selectedImage && (
            <div className="w-[9rem] h-[8rem] flex justify-center -mt-2 rounded-2xl">
              <img
                className="w-full object-cover rounded-[100%]"
                src={selectedImage}
                alt="fotografia"
              />
            </div>
      ...
      <div className="mb-2 shadow-2xl">
        ...
        <div className="w-full flex flex-wrap justify-around gap-1 pl-2 text-black">
          ...
          <List lists={listResponsabilitysWork} fontSize="text-base" />
        </div>
      </div>

      {isShowExperience && (
        <div className="shadow-2xl">
          <div className="w-full flex flex-wrap justify-around gap-1 pl-2 bg-white text-black">
            <p>
              <span className="font-bold">Empresa </span>
              {company2}
            </p>
            ...
            <List lists={listResponsabilitysWork2} fontSize="text-base" />
          </div>
        </div>
      )}
    </article>
